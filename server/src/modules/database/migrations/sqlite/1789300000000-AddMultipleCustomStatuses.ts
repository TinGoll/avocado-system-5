  ...
  implements MigrationInterface
{
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT OR IGNORE INTO "order_group_custom_statuses" ("orderGroupId", "customStatusId") SELECT "id", "customStatusId" FROM "order_groups" WHERE "customStatusId" IS NOT NULL`,
    );
    ...
    await queryRunner.query(
      `INSERT OR IGNORE INTO "order_custom_statuses" ("orderId", "customStatusId") SELECT "id", "customStatusId" FROM "orders" WHERE "customStatusId" IS NOT NULL`,
    );
  }
