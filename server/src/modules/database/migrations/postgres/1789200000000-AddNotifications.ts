...
export class AddNotifications1789200000000 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "notifications" ("id" uuid PRIMARY KEY NOT NULL DEFAULT uuid_generate_v4(), "dedupKey" text NOT NULL, "ruleId" uuid, "ruleRevision" integer NOT NULL, "orderGroupId" integer, "orderId" uuid, "trigger" text NOT NULL, "severity" text NOT NULL, "message" jsonb NOT NULL DEFAULT '[]'::jsonb, "targetSnapshot" jsonb NOT NULL DEFAULT '{}'::jsonb, "createdAt" timestamptz NOT NULL DEFAULT now(), "readAt" timestamptz, "resolvedAt" timestamptz, CONSTRAINT "FK_notifications_rule" FOREIGN KEY ("ruleId") REFERENCES "notification_rules" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_notifications_group" FOREIGN KEY ("orderGroupId") REFERENCES "order_groups" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_notifications_order" FOREIGN KEY ("orderId") REFERENCES "orders" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
