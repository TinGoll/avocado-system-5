  ...
  customers: [
    {
      id: 'customer-1',
      name: 'Иван Петров',
      companyName: 'ООО «Авокадо»',
      address: 'Москва, ул. Лесная, 10',
      phone: '+7 999 123-45-67',
      email: 'ivan@example.com',
      comment: 'Предпочитает связь по телефону',
      attributes: { source: 'Рекомендация', isPartner: true },
      level: 'gold',
    },
    {
      id: 'customer-2',
      ...
      items: [
        {
          ...
          characteristics: {
            ...
            height: 720,
            thickness: 20,
            comment: 'Верхние шкафы, петли справа',
          },
          calculatedProductionCost: 18400,
        ...
        },
        {
          ...
          characteristics: {
            ...
            height: 720,
            thickness: 30,
            comment: 'Комплект к крайним секциям',
          },
          calculatedProductionCost: 4800,
      ...
      items: [
        {
          ...
          characteristics: {
            ...
            height: 360,
            thickness: 20,
            comment: 'Витринные фасады, без отверстий под ручки',
          },
          calculatedProductionCost: 8400,
      ...
      items: [
        {
          ...
          characteristics: {
            ...
            height: 900,
            thickness: 30,
            comment: 'Подрезать по месту после примерки',
          },
          calculatedProductionCost: 6400,
