...
export const CreateForm: FC<Props> = ({ onCancel, onCreated }) => {
  ...
  const { isMutating, trigger, isLoading } = useCreateVarnish();
    ...
    <Skeleton loading={isLoading} active>
      ...
      >
        <Form.Item<FieldType>
          label="Название"
          name="name"
          tooltip="Название лака должно быть уникальным"
          rules={[{ required: true, message: 'Введи название лака' }]}
        >
          <Input />
        </Form.Item>
